...
async def check():
    ...
    assert sum(domain == "script" and action == "turn_on" for domain, action, _ in calls) == 2, calls
    ...
    print("HA schemas, 18 template cases and controller lifecycle passed; no live services called.")
