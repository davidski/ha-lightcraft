...
func (a *webApp) page(view, edit string) (webPage, error) {
	...
	for _, id := range colorIDs(a.bundle) {
		...
		page.Colors = append(page.Colors, webColor{ID: id, Name: color.Name, X: color.X, Y: color.Y})
	}
